...
<body>
    ...
    <%
        ...
        // Fetch product and order statistics
        ProductDAO pdao = new ProductDAOImp();
        int uploadedProducts = pdao.getProducts(f.getFarmer_id()).size();

        OrderDAO odao = new OrdersDAOIpml();
        int purchasedProducts = odao.getAllorders(f.getFarmer_id()).size();
    %>
        ...
        const productGraph = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [<%= uploadedProducts %>, <%= purchasedProducts %>], // Dynamic Data
